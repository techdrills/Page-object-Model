...
package com.qa.hostel.utilityPackage;
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			// return cell.getStringCellValue();
				...
				{
					cellText = cellText.substring(0, cellText.length()-2); // will remove .0 from number
				}
				// to get complete number value
				if(cell.getCellType().name().equals("NUMERIC")) {
				    cellText = NumberToTextConverter.toText(cell.getNumericCellValue()); // will accept till 15 digit no's.
				}
